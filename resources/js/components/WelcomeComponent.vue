                    ...
                    <div class="col my-auto">
                      ...
                      <div>
                        ...
                        <div class="stat-row">
                          <div class="row">
                            <div class="col-12">
                              <span class="font-compare text-white">Cases Per Million</span>
                            </div>
                            <div class="col">
                              <h5 class="m-0">
                                {{
                        ...
                        <div class="stat-row">
                          <div class="row">
                            <div class="col-12">
                              <span class="font-compare text-white">Tests Per Million</span>
                            </div>
                            <div class="col">
                              <h5 class="m-0">
                                {{
                        ...
                        <div class="stat-row">
                          <div class="row">
                            <div class="col-12">
                              <span class="font-compare text-white">Deaths Per Million</span>
                            </div>
                            <div class="col">
                              <h5 class="m-0">
                                {{
            ...
            <div class="mt-5 mt-lg-0 b-12 bg-white con-box">
              ...
              <div v-if="topViewStyle == 'boxes'">
                ...
                >
                  ...
                  >
                    <div class="col-3">
                      <img :src="country.countryInfo.flag" class="img-fluid" :alt="country.country" />
                    </div>
                    <div class="col-7">

...
<body>
  <div  id="particles-js"> </div>
          ...
          <div class="col">
            ...
            <a
              ...
              <div class="resp-sharing-button resp-sharing-button--whatsapp resp-sharing-button--medium">
                <div aria-hidden="true" class="resp-sharing-button__icon resp-sharing-button__icon--circle"></div>
                WhatsApp
              </div>
            </a> <a
    ...
    <footer class="py-5 text-body font-percent bg-light">

      <div class="container">
        <div class="row">
          <div class="col-lg-8 mx-auto mt-3 text-center">
            <img src="/img/virus.png" height="60" alt="corona virus" /><br>
            <small class="text-black-50">Statistics & News</small>
            <h5 class="mt-3">About This Data</h5>
            <p class="text-black-50">
              This data changes rapidly, so what’s shown may be out of date. Table totals may not always represent an
              accurate sum. Information about reported cases is also available on the World Health Organisation site.
              It doesn’t include all cases
              Confirmed cases aren’t all cases. They only include people who tested positive. Testing rules and
              availability vary by country. The Data on China is not accurate but whats available in the data source. No
              guarantee's are made about the accuracy or validty of this data in anyway.
            </p>
          </div>
        </div>
        <div class="row text-center">
          ...
          <div class="col-md-4 mt-3">
            <h5>Links</h5>
            <a class="text-success" href="/">Statistics</a><br>

            <a class="text-success" href="/symptoms">Symptoms</a><br>

            <a class="text-success" href="/contacts">Contacts <small class="font-weight-normal text-black-50">(South
                Africa)</small></a>
